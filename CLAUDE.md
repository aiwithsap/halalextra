...
3. Once inspector has approved the shop for certification, a Bar code is generated by our app which is unique to this retail shop and can be pasted for public viewing by the shop owner. Anyone should be able to scan this certificate via their phone's QR scanner. This will lead to a webpage on our website showing the current certification status of the shop and expiry date of the certification.
4. An admin dashboard is needed so an overview of all the certifications in progress or ones that have expired or close to expiration can be seen. 
